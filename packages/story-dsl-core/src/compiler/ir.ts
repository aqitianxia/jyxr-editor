...
export type ValueArgIr = string | number | boolean | VariableExprIr | ListValueArgIr;
...
export type ExprIr = string | number | boolean | VariableExprIr | PredicateExprIr | UnaryExprIr | BinaryExprIr;
