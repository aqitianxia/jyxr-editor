...
export class ParserContext extends LineCursor {
  ...
  readonly zeroArgumentPredicates: ReadonlySet<string>;

  constructor(text: string, zeroArgumentPredicates: Iterable<string> = []) {
    super(text);
    this.zeroArgumentPredicates = new Set(zeroArgumentPredicates);
  }
