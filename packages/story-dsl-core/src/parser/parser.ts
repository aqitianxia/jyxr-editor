...
export interface ParseStoryOptions {
  zeroArgumentPredicates?: Iterable<string>;
}
...
export class StoryParser {
  ...
  constructor(text: string, options: ParseStoryOptions = {}) {
...
export function parseStory(text: string, options: ParseStoryOptions = {}): ParseStoryResult {
